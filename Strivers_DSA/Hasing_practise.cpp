...
void find_max_min_occurrence(int arr[], int size) {
    ...
    // Output results
    cout << "Minimum occurrence: " << minEle
         << " appears " << minFreq << " time(s)" << endl;
    cout << "Maximum occurrence: " << maxEle
         << " appears " << maxFreq << " time(s)" << endl;
}
...
int main() {
    ...
    // cin >> n;
    // cout << "Occurrence of " << n << ": "
    //      << find_occurrence(arr, size, n) << endl;
    ...
    //      << find_char_occurrence(inputStr, ch) << endl;
